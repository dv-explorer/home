...
function setupInteraction() {
    ...
    document.getElementsByClassName("card-frontImg").oncontextmenu = nocontextmenu; // for IE5+ 
    document.getElementsByClassName("card-frontImg").onmousedown = norightclick; // for all others 
}
