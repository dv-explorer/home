...
function setupInteraction() {
    ...
    document.getElementsByClassName("card-prevImg").oncontextmenu = nocontextmenu; // for IE5+ 
    document.getElementsByClassName("card-prevImg").onmousedown = norightclick; // for all others 
}
