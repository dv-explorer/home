...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import imagesLoaded from 'imagesloaded';
&nbsp;
import {
  pipe,
  normalizeElements,
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.responsive) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  _r</span>emoveEventListener($image, event, listener) {
<span class="cstat-no" title="statement not covered" >    $image.removeEventListener(event, listener);</span>
  }
&nbsp;
  _injectStylesheet() {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if ($container.classList.contains(classes.READY)) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isActive) {
<span class="cstat-no" title="statement not covered" >      this._toggleOff(freeze);</span>
    } else {
      this._toggleOn(freeze);
    }
    return !isActive;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  to</span>ggle() {
<span class="cstat-no" title="statement not covered" >    this.items.forEach(<span class="fstat-no" title="function not covered" >(f</span>reeze) =&gt; {</span>
      const isPlaying = <span class="cstat-no" title="statement not covered" >this._toggle(freeze);</span>
<span class="cstat-no" title="statement not covered" >      if (isPlaying) {</span>
<span class="cstat-no" title="statement not covered" >        this._emit(events.START, this.items, false);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        this._emit(events.STOP, this.items, false);</span>
      }
<span class="cstat-no" title="statement not covered" >      this._emit(events.TOGGLE, this.items, isPlaying);</span>
    });
  }
&nbsp;
  on(event, cb) {
...
<span class="cstat-no" title="statement not covered" >    this._internalEvents.forEach(<span class="fstat-no" title="function not covered" >({</span> $image, event, listener }) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this._removeEventListener($image, event, listener);</span>
    });
  }
}
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sun Mar 15 2020 10:35:21 GMT-0400 (Eastern Daylight Time)
            </div>
        </div>
