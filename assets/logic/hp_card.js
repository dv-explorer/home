...
class Homepage_Card {
    constructor(parameters = { 
        card_id, card_title, VNS_tag, VNS_ambiguity, EL_tag, AVT_tag, how, why, 
...
class Homepage_Reminder {
    ...
    _createReminder (methodToReminderTitle = str => str) {
        ...
        let reminder_title_html = `<span class="reminder-title">${methodToReminderTitle(this._VNS_tag)} (${this._VNS_num})</span>`;
