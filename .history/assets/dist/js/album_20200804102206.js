...
function setupInteraction() {
    ...
    $(window).resize(function() {
        ...
        if(classStr.length > 0){
            ...
            $("div.btn-secondary-group").removeClass("btn-primary-group").addClass("btn-primary-group" + classStr);
        } else {
            $("div.btn-primary-group").removeClass("btn-primary-group-sm").addClass("btn-primary-group" + classStr);
            $("div.btn-secondary-group").removeClass("btn-primary-group-sm").addClass("btn-primary-group" + classStr);
        }
    });
