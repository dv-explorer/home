...
function setupInteraction() {
    ...
    // for IE5+ 
    document.getElementsByTagName("img").oncontextmenu = nocontextmenu; 
    // document.getElementsByTagName("img").addEventListener("contextmenu", nocontextmenu); 
    // for all others 
    document.getElementsByTagName("img").onmousedown = norightclick; 
    // document.getElementsByTagName("img").addEventListener("mousedown", norightclick); 
}
