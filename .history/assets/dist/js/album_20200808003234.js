...
function deckDisplay() {
    $("#card-display > div").each(function(i, part) {
        ...
        console.log("5 - " + $(part).attr("id") + " " + $(cardDeck).children(".trans-3d[display='block']").length); //5
        console.log("6 - ", ($(cardDeck).children(".trans-3d[display='block']").length == 0) && $(part).is(":visible")); //6
        if(($(cardDeck).children(".trans-3d[display='block']").length == 0) && $(part).is(":visible")) {
        ...
        console.log("8 - ", ($(cardDeck).children(".trans-3d[display='block']").length > 0) && $(part).is(":hidden")); //8
        if(($(cardDeck).children(".trans-3d[display='block']").length > 0) && $(part).is(":hidden")) {
