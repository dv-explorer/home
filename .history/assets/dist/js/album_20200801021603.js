...
function setupInteraction() {
    ...
    // image lazy loading
    $(".card-deck .back").ImgLoading({state: "back", timeout: 360});
    $(".card-deck .front").ImgLoading({state: "front", timeout: 360});
        ...
        var plus = {
            ...
            LoadImg: function (obj, imgindex) {
                setTimeout(function () {
                    ...
                    if(defaults.state == "front") {const logo = new Freezeframe(obj);}
                }, defaults.timeout);
            }
        }
        plus.LoadState();
