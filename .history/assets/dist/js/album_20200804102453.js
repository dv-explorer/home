...
function setupInteraction() {
    ...
    $(window).resize(function() {
        ...
        if(classStr.length > 0){
            ...
            $("div.btn-secondary-group").removeClass("btn-secondary-group").addClass("btn-secondary-group" + classStr);
        } else {
            $("div.btn-primary-group").removeClass("btn-primary-group-sm").addClass("list-group btn-primary-group" + classStr);
            $("div.btn-secondary-group").removeClass("btn-secondary-group-sm").addClass("btn-secondary-group" + classStr);
        }
    });
...
function createNS(NS_doc) {
    ...
    // create NS part
    var NS_Group = $("<div></div>").addClass(classStr + " list-group")
...
function createEL(EL_doc, x) {
    var classStr = "btn-secondary-group" + panelLayout();
