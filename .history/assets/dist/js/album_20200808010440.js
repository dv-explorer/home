...
function deckDisplay() {
    $("#card-display > div").each(function(i, part) {
        ...
        console.log("5 - " + $(part).attr("id") + " " + $(cardDeck).find(".trans-3d:visible").length); //5
        console.log("6 - ", ($(cardDeck).find(".trans-3d:visible").length == 0) && $(part).is(":visible")); //6
        ...
        console.log("8 - ", ($(cardDeck).find(".trans-3d:visible").length > 0) && $(part).is(":hidden")); //8
