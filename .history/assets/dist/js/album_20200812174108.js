...
function searchFunc() {
    ...
    if(read.length > 0 && (read[0] != ("" | " "))) {
        ...
        if(read.length === 1 && $($("#" + read.toLowerCase()).parent()[0]).attr("id") === "card-display") {
            $(".btn-primary-group > a").removeClass("disabled");
            $(".btn-primary-group-sm > a").removeClass("disabled");
            ...
            $(".btn-primary-group-sm > ." + read.toLowerCase()).addClass("active");
