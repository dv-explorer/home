...
function displaySpy() {
    ...
    $.each(document.querySelectorAll(".deck-reminder").toArray(), (i, reminder) => {
        var position = document.querySelector(reminder).getBoundingClientRect().top - $("#card-display").position().top;
        console.log(postion);
    })
    // $(".deck-reminder:visible").each((i, reminder) => {
